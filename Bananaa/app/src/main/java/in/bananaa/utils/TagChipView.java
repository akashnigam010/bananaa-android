...
public class TagChipView extends ViewGroup implements Observer {
    private ChipViewAdapter mAdapter;
    private OnTagChipClickListener mListener;
    ...
    public TagChipView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public TagChipView(Context context, AttributeSet attrs, int defStyleAttr) {
                ...
                if (mListener != null) {
                    ...
                    childView.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            mListener.onChipClick(chip, v, finalI);
                        }
                    });
                }
            }
     ...
     * @param listener
     */
    public void setOnChipClickListener(OnTagChipClickListener listener) {
        mListener = listener;
    }
