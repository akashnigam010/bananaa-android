...
public class DataGenerator {
    ...
    public static List<TagChip> getSuggestionTags(int page) {
        ...
        if (page == 1) {
            ...
            items.add(getSuggestionTag(41, "Noodlesas sd"));
            items.add(getSuggestionTag(42, "Noodles"));
            items.add(getSuggestionTag(43, "Noodlesa "));
            items.add(getSuggestionTag(44, "Nood"));
            items.add(getSuggestionTag(45, "Noodlesasd asd asd"));
            items.add(getSuggestionTag(46, "Nood"));
            items.add(getSuggestionTag(47, "Noodl sdsd"));
            items.add(getSuggestionTag(48, "Noodles ads"));
            items.add(getSuggestionTag(49, "Noodles"));
            items.add(getSuggestionTag(50, "Noodlesasd"));
        } else if (page == 6) {
            items.add(getSuggestionTag(51, "Noodlesas sd"));
            items.add(getSuggestionTag(52, "Noodles"));
            items.add(getSuggestionTag(53, "Noodlesa "));
            items.add(getSuggestionTag(54, "Nood"));
            items.add(getSuggestionTag(55, "Noodlesasd asd asd"));
            items.add(getSuggestionTag(56, "Nood"));
            items.add(getSuggestionTag(57, "Noodl sdsd"));
            items.add(getSuggestionTag(58, "Noodles ads"));
            items.add(getSuggestionTag(59, "Noodles"));
            items.add(getSuggestionTag(60, "Noodlesasd"));
        }
        return items;
    }

    private static TagChip getSuggestionTag(Integer id, String name) {
        return new TagChip(id, name, SearchResultType.DISH, false);
    }
